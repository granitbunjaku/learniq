    ...
    return (
        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow">
            ...
            <div class="p-4">
                ...
                <p class="font-semibold mb-2">Dollar Design School</p>
                <div class="flex items-center mb-6">
                    ...
                    <p class="ml-2 text-sm font-medium text-gray-500 dark:text-gray-400">{t('description.categories.cards.rating')}</p>
                </div>
                ...
                <div class="flex items-center flex-wrap">
                    <button type="button" class="text-blue-700 flex items-center border border-blue-700 transition hover:ease-in-out duration-500 hover:text-white hover:bg-blue-800 focus:ring-0 focus:bg-blue-900 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 focus:outline-none">
                            ...
                            {t('description.categories.cards.add')}
                    </button>
                    <Link to={`/courses/1`} class="flex items-center font-medium text-sm px-5 py-2.5 text-center mr-2" href="#">{t('description.categories.cards.learn')}
