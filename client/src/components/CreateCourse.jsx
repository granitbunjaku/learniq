...
const CreateCourse = () => {
  ...
  return (
    <div class="p-6">
        ...
        <form class="p-6">
            <div class="mb-6">
                <label for="email" class="mb-2 block text-sm font-medium font-poppins text-gray-900">Course Name</label>
                <input type="email" id="email" class="block w-full  font-poppins rounded-lg border border-gray-300 bg-white p-2.5 text-sm text-gray-900 shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="name@flowbite.com" required />
                </div>
                <div class="mb-6">
                ...
                <div class="mb-6 flex items-start">
                    <div class="flex h-5 items-center">
                        <input id="terms" type="checkbox" value="" class="focus:ring-3 h-4 w-4 font-poppins rounded border border-gray-300 bg-gray-50 focus:ring-blue-300" required />
                    </div>
                    <label for="terms" class="ml-2 text-sm font-medium text-gray-900 font-poppins">I agree with the <a href="#" class="text-blue-600 hover:underline">terms and conditions</a></label>
                </div>

                <button type="submit" class="rounded-lg bg-blue-700 px-5 py-2.5 text-center text-sm font-poppins font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300">Create new course</button>
