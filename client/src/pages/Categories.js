  ...
  return (
    <>
        <div class="md:px-16 px-8">
            <p class="text-xl font-semibold mb-6 text-center mt-12">{t('description.categories.hero.title')}</p>
        ...
        <div class="mb-12 grid gap-5 px-14 md:grid-cols-1 md:grid-rows-1 lg:px-40 xl:grid-cols-3 xl:grid-rows-2">
            ...
            <h2 id="accordion-collapse-heading-1" onClick={() => setShowTopic(!showTopic)}>
                ...
                <span>{t('description.categories.filters.topic')}</span>
            ...
            <h2 id="accordion-collapse-heading-2" onClick={() => setShowSubcategory(!showSubcategory)}>
                ...
                <span>{t('description.categories.filters.subcategory')}</span>
            ...
            <h2 id="accordion-collapse-heading-3" onClick={() => setShowLevel(!showLevel)}>
                ...
                <span>{t('description.categories.filters.level')}</span>
            ...
            <h2 id="accordion-collapse-heading-3" onClick={() => setShowPrice(!showPrice)}>
                ...
                <span>{t('description.categories.filters.price')}</span>
            ...
            <a href="#" class="flex max-w-full flex-col lg:h-64 xs:h-auto items-center rounded-lg border border-gray-200 bg-white shadow hover:bg-gray-100 lg:flex-row xl:col-span-2">
                ...
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">{t('description.categories.course.title')}</h5>
                ...
                <div class="flex flex-wrap items-center">
                    ...
                    <p class="ml-2 text-sm font-medium text-gray-500">{t('description.categories.course.rating')}</p>
                </div>
                <p class="mb-3 font-normal text-gray-700">{t('description.categories.course.desc')}</p>
                </div>
