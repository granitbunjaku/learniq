...
const Students = () => {
  return (
    <div className="relative w-3/4 float-right px-12">
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    <tr class="bg-white dark:bg-gray-800">
                        <Link to='/dashboard/courses/1/students/1' scope="row" class="px-6 underline py-6 flex item-center font-medium text-gray-900 whitespace-nowrap dark:text-white">
