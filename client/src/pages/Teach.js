    ...
    <section className="bg-white">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
            <a href="#" className="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-green-600 rounded-full dark:text-white hover:bg-green-700" role="alert">
                <span className="text-xs bg-primary-600 rounded-full text-white px-4 py-1.5 mr-3">New</span> <span className="text-sm font-medium">New categories are out</span> 
                <svg className="ml-2 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
            </a>
            <h1 className="font-bold text-6xl text-black">Become a teacher with us!</h1>
            <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400 mt-6">Dont't lose the chance to become a great teacher and change life of others, including your own too. Register right now and start teaching.</p>
            ...
            <div class="flex max-w-sm items-center justify-center m-0">
                <div class="max-w-sm w-150 rounded-md bg-gradient-to-r from-green-400 to-blue-500 p-1 hover:rotate-6 transform-gpu transition ease-in-out group h-92">
                    <div class="max-w-sm p-6 w-150 border bg-white rounded-lg shadow">
                        ...
                        <a href="#">
                            <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900">Flexibility</h5>
                        </a>
                        <p class="mb-3 font-normal text-gray-500">Online teaching allows for a flexible schedule, which can be particularly appealing to those with other commitments such as family, another job, or personal interests.</p>
                    </div>
                </div>
            </div>
            <div class="flex max-w-sm items-center justify-center m-0">
                <div class=" max-w-sm w-150 rounded-md bg-gradient-to-r from-green-400 to-blue-500 p-1 hover:rotate-6 transform-gpu transition ease-in-out group h-92">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 text-gray-400" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><polyline points="64 88 16 128 64 168" fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></polyline><polyline points="192 88 240 128 192 168" fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></polyline><line x1="160" y1="40" x2="96" y2="216" fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line></svg>
                        <a href="#">
                            <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900">Technological skills</h5>
                        </a>
                        <p class="mb-3 font-normal text-gray-500">Online teaching requires proficiency with a range of technology, which can be an appealing opportunity for those who enjoy working with computers and software.</p>
                    </div>
                </div>
            </div>
            <div class="flex max-w-sm items-center justify-center m-0">
                <div class=" max-w-sm w-150 rounded-md bg-gradient-to-r from-green-400 to-blue-500 p-1 hover:rotate-6 transform-gpu transition ease-in-out group h-92">
                    <div class="max-w-sm p-6 w-150 border bg-white rounded-lg shadow">
                        ...
                        <a href="#">
                            <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900">Increased reach</h5>
                        </a>
                        <p class="mb-3 font-normal text-gray-500">Online teaching provides an opportunity to reach students from all over the world, rather than being limited to a specific geographic area.</p>
                    </div>
                </div>
            </div>
        </div>
